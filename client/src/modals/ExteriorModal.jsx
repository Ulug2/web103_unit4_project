...
import "./ExteriorModal.css";
import data from "../customization_data/data.js";

export default function useExteriorModal(open) {
  const exteriorData = data.exteriorData;
  ...
  return { ExteriorModal, choice, resetChoice };
}